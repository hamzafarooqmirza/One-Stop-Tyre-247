...
export const metadata = buildMetadata({
  ...
  description:
    'Need mobile tyre fitting in Newton Heath? Fast, reliable service, 24/7.',
      ...
      <main>
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Mobile Tyre Fitting Across Newton Heath
            </h2>
            
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              Newton Heath in north Manchester, with Errwood Park and the streets around Ten Acres Lane forming its residential core, sees a steady mix of local and commuter traffic. Our mobile tyre fitting service covers Newton Heath and the surrounding M40 postcode area, bringing a fully equipped van directly to your home, workplace or the roadside.
            </p>
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              We're a regular presence around Errwood Park and Ten Acres Lane, and along the A62 and M60 that carry most of Newton Heath's traffic towards the city centre and Oldham. Whether you've picked up a puncture on the A62 or a sidewall cut on a residential street near Errwood Park, our technicians carry the tools and stock to sort it on-site.
            </p>
            <p className="text-slate-600 text-base leading-relaxed">
              Mobile tyre fitting in Newton Heath covers everything from a same-day puncture repair to a full emergency tyre replacement after a blowout, with premium, mid-range and budget tyre options fitted to the same standard regardless of price. We aim to reach any Newton Heath postcode within 20–30 minutes, and every job includes a TPMS check so your dashboard warning light is cleared before we leave.
            </p>
          </div>
        </section>
