  ...
  return (
    <div className="text-[#1c1b1b]" style={{ fontFamily: 'var(--font-inter)' }}>
      ...
      <div className="fixed bottom-6 right-6 z-[60] flex flex-col gap-4">
        {/* Verified badge */}
        <div className="bg-white/95 backdrop-blur shadow-2xl rounded-2xl p-4 border border-slate-200 items-center gap-3 animate-bounce hidden sm:flex">
          ...
          <div className="leading-tight">
            ...
            <p className="text-xs font-black text-[#0f172a]">Expert Techs Nearby</p>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <a
            ...
            className="w-16 h-16 bg-green-500 text-white rounded-2xl flex items-center justify-center shadow-2xl hover:scale-110 transition-transform active:scale-95"
          >
          ...
          <a
            ...
            className="w-16 h-16 bg-[#b70011] text-white rounded-2xl flex flex-col items-center justify-center shadow-2xl hover:scale-110 transition-all active:scale-95 group relative overflow-hidden"
          >
            ...
            <span className="text-[8px] font-black uppercase relative z-10">Emergency</span>
          </a>
        </div>
      </div>
    </div>
