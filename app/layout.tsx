    ...
    <html lang="en" className={`${workSans.variable} ${inter.variable} bg-[#fcf9f8]`}>
      <head>
        ...
        <link
          rel="preload"
          as="image"
          href="/images/Mobile Tyre Fitting One Stop Tyres 24 7.webp"
          type="image/webp"
        />
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      ...
      <body className="antialiased overflow-x-hidden">
        ...
        <div className="fixed bottom-20 sm:bottom-6 right-4 sm:right-5 z-[60] flex flex-col gap-3 sm:gap-4">
          <a
            href="https://wa.me/447759708646"
            aria-label="Chat on WhatsApp"
            className="w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] hover:bg-[#1ebe5d] rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all hover:scale-110 active:scale-95"
          >
            <svg className="w-7 h-7 sm:w-8 sm:h-8 fill-white" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <a
            ...
            className="w-14 h-14 sm:w-16 sm:h-16 bg-[#FF4444] hover:bg-red-700 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all hover:scale-110 active:scale-95"
          >
            <span
