  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      <main>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Emergency tyre replacement service across Bury for damaged, worn or blown tyres. We get you safely back on the road quickly.',
                  badge: 'AT YOUR DOOR',
                ...
                },
                {
                  ...
                  desc: 'Emergency roadside tyre assistance throughout Bury. Available 24 hours a day for tyre-related breakdowns and call-outs.',
                  badge: '24/7 SERVICE',
                  href: '/services',
                },
                {
        ...
        <WhyChooseUs city="Bury" image="/images/Mobile Tyre Fitting Manchester-airanko (1).webp" />
