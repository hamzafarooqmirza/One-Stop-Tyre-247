...
export const metadata = buildMetadata({
  title: 'Mobile Tyre Fitting Basingstoke | One Stop Tyres 24/7',
  description:
    'Same-day mobile tyre fitting in Basingstoke — fast tyre replacement and puncture repair at home, work or roadside.',
      ...
      <main>
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Mobile Tyre Fitting Across Basingstoke
            </h2>
            
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              Basingstoke's town centre and Festival Place shopping district sit alongside busy commuter routes towards London, and a punctured tyre can happen in either. Our mobile tyre fitting service covers Basingstoke town centre, Festival Place and Chineham, along with the surrounding RG21-RG24 postcode area, bringing a fully equipped van directly to your home, workplace or the roadside.
            </p>
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              We're a regular presence around Festival Place and the town centre, and along the M3 and A33/A339 corridors that carry most of Basingstoke's commuter traffic. Whether you've picked up a puncture heading into town or a sidewall cut in a suburban street in Chineham, our technicians carry the tools and stock to sort it on-site.
            </p>
            <p className="text-slate-600 text-base leading-relaxed">
              Mobile tyre fitting in Basingstoke covers everything from a same-day puncture repair to a full emergency tyre replacement after a blowout, with premium, mid-range and budget tyre options fitted to the same standard regardless of price. As a directly employed team, we dispatch to any Basingstoke postcode the same day, and every job includes a TPMS check so your dashboard warning light is cleared before we leave.
            </p>
          </div>
        </section>
        ...
        <CityFaq
          ...
          faqs={[
            ...
            {
              q: 'What tyre brands do you carry for Basingstoke customers?',
            ...
            {
              q: 'Are you available on Bank Holidays in Basingstoke?',
