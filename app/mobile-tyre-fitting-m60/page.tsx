...
export const metadata = {
  ...
  description:
    'Fast and reliable mobile tyre fitting service available 24/7 on the M60 and surrounding junctions. We arrive in 30-60 minutes to get you back on your journey safely.',
}
...
export default function M60Page() {
  return (
    <ServicePage
      ...
      heroSubheading="Fast and reliable mobile tyre fitting service available 24/7 on the M60 and surrounding junctions. We arrive in 30-60 minutes to get you back on your journey safely."
      ...
      whyChooseUs={[
        ...
        '30-60 minute average arrival time across the full M60 ring road',
      ]}
      benefits={[
        '30-60 Min Arrival — fastest possible response across the M60 ring road',
      ...
      faqs={[
        ...
        },
        {
          ...
          a: 'Our average arrival time across the M60 ring road is 30-60 minutes. Our central Greater Manchester location gives us quick access to all junctions.',
        },
      ]}
    />
  )
