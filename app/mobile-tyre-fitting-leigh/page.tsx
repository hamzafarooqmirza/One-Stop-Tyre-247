...
export const metadata = {
  title: 'Mobile Tyre Fitting in Leigh | 24/7 Tyre Fitting',
  description:
  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
        ...
        {/* ── 5. WHY CHOOSE US */}
        <WhyChooseUs city="Leigh" image="/images/tyre fitting in emergergency-airanko (1).webp" />
