        ...
        >
          <div className="max-w-4xl mx-auto py-20">
            <div className="inline-flex items-center gap-2 bg-[#dc2626] text-white px-4 py-2 rounded-full mb-4 animate-pulse">
              ...
              <span className="text-label-bold">24/7 M67 EMERGENCY RESPONSE</span>
            </div>
            <h1
            ...
            >
              ...
              <span className="text-[#b70011]">M67</span>
            </h1>
            <p className="font-body-lg text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed mb-8">Fast and reliable mobile tyre fitting service available 24/7 on the M67 and surrounding areas. We get you back on the road in under 60 minutes.</p>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              ...
              >
                Professional Roadside Assistance on the M67
              </h2>
              <p className="text-slate-600 max-w-2xl mx-auto text-sm sm:text-base">
                Comprehensive mobile vehicle support available every day of the year across the M67 corridor and surrounding Tameside, Hyde, and Denton routes.
              </p>
            </div>
