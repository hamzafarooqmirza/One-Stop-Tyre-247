...
export const metadata = buildMetadata({
  title: 'Mobile Tyre Fitting in Hulme | 24/7 Tyre Fitting',
  description:
    '24/7 mobile tyre fitting in Hulme, Manchester — fast tyre replacement & puncture repair at home, work or roadside across M15. 20–30 min response.',
          ...
          faqs={[
            {
              ...
              a: 'Our mobile units are strategically positioned across Greater Manchester, meaning we can typically reach Hulme and the surrounding M15 postcode area within 20-30 minutes.',
            },
            {
              q: 'What areas around Hulme do you cover?',
              a: 'Yes. We cover Hulme and the surrounding M15 postcode area, along with the main routes connecting it to the rest of Manchester and the M60.',
            },
            {
              q: 'What tyre brands do you carry for Hulme customers?',
            ...
            {
              q: 'Are you available on Bank Holidays in Hulme?',
