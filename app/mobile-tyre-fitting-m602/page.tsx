      ...
      <main>
        ...
        >
          <div className="max-w-4xl mx-auto py-20">
            <div className="inline-flex items-center gap-2 bg-[#dc2626] text-white px-4 py-2 rounded-full mb-4 animate-pulse">
              ...
              <span className="text-label-bold">24/7 M602 EMERGENCY RESPONSE</span>
            </div>
            <h1
            ...
            >
              ...
              <span className="text-[#b70011]">M602</span>
            </h1>
            <p className="font-body-lg text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed mb-8">Fast and reliable mobile tyre fitting service available 24/7 on the M602 and surrounding areas. We get you back on the road in under 60 minutes.</p>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              ...
              >
                Professional Roadside Assistance on the M602
              </h2>
              <p className="text-slate-600 max-w-2xl mx-auto text-sm sm:text-base">
                Comprehensive mobile vehicle support available every day of the year across the M602 corridor and surrounding Salford routes.
              </p>
            </div>
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="font-body-lg text-sm sm:text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait on the hard shoulder. Call our dedicated M602 line and get a technician dispatched in minutes.</p>
