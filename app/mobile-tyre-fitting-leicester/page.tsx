...
export const metadata = buildMetadata({
  title: 'Mobile Tyre Fitting in Leicester | 24/7 Tyre Fitting',
  description:
    'Same-day mobile tyre fitting in Leicester — fast tyre replacement & puncture repair at home, work or roadside across LE1 – LE19. Call or WhatsApp.',
      ...
      <main>
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Mobile Tyre Fitting Across Leicester
            </h2>
            
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              Leicester's mix of a compact city centre and spread-out suburbs means a breakdown can happen a long way from the nearest tyre shop. Our mobile tyre fitting service covers the city centre, Highcross and Clarendon Park, along with the wider LE postcode area, bringing a fully equipped van directly to your home, workplace or the roadside.
            </p>
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              We're a regular presence around the city centre's retail and business districts, and along the M1 and A46 corridors that carry most of Leicester's commuter traffic. Whether you've picked up a puncture heading into town or a sidewall cut in a suburban street, our technicians carry the tools and stock to sort it on-site.
            </p>
            <p className="text-slate-600 text-base leading-relaxed">
              Mobile tyre fitting in Leicester covers everything from a same-day puncture repair to a full emergency tyre replacement after a blowout, with premium, mid-range and budget tyre options fitted to the same standard regardless of price. As a directly employed team, we dispatch to any Leicester postcode the same day, and every job includes a TPMS check so your dashboard warning light is cleared before we leave.
            </p>
          </div>
        </section>
