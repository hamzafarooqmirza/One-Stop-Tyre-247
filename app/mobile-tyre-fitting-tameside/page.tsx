  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      <main>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Emergency tyre replacement service across Tameside for damaged, worn or blown tyres. We get you safely back on the road quickly.',
                  badge: 'AT YOUR DOOR',
                ...
                },
                {
                  ...
                  desc: 'Emergency roadside tyre assistance throughout Tameside. Available 24 hours a day for tyre-related breakdowns and call-outs.',
                  badge: '24/7 SERVICE',
                  href: '/services',
                },
                {
        ...
        {/* ── 5. WHY CHOOSE US ──────────────────────────────── */}
        <WhyChooseUs city="Tameside" image="/images/Tyres fitting anywhere-airanko (1).webp" />
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="font-body-lg text-sm sm:text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait by the roadside. Call our dedicated Tameside line and get a technician dispatched in minutes.</p>
