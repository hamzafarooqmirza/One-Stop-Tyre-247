        ...
        >
          <div className="max-w-4xl mx-auto py-20">
            <div className="inline-flex items-center gap-2 bg-[#dc2626] text-white px-4 py-2 rounded-full mb-4 animate-pulse">
              ...
              <span className="text-label-bold">24/7 WIGAN EMERGENCY RESPONSE</span>
            </div>
            <h1
            ...
            >
              ...
              <span className="text-[#FF7A88]">Wigan</span>
            </h1>
            <p className="font-body-lg text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed mb-8">Rapid 24/7 mobile tyre fitting across Wigan, Standish, Hindley and Leigh. Our local technicians arrive in 20-30 minutes — fully equipped for cars, vans, and motorway emergencies on the M6.</p>
