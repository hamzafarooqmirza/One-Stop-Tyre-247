...
export const metadata = {
  ...
  description:
    'Mobile tyre fitting in Radcliffe with same day tyre fitting, emergency tyre replacement and trusted mobile tyre fitters near you.',
  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
        ...
        >
          <div className="max-w-2xl py-20">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-white mb-4 leading-[1.1] font-black text-balance" style={{ fontFamily: 'var(--font-work-sans)', letterSpacing: '-0.02em' }}>
              24/7 Mobile Tyre Fitting Radcliffe
            </h1>
            <p className="text-white/80 text-base leading-relaxed mb-6">
              Emergency Tyre Replacement, Mobile Puncture Repair &amp; Roadside Tyre Assistance Across Radcliffe. We Come To Your Home, Workplace Or Roadside Location Within 20–30 Minutes.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 mb-6">
              {[
                ...
                'Covering Radcliffe & Surrounding Areas 24/7',
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <h2 className="text-2xl sm:text-[32px] font-bold text-slate-900 mb-3 leading-tight" style={{ fontFamily: 'var(--font-work-sans)', letterSpacing: '-0.01em' }}>
                24/7 Mobile Tyre Fitting &amp; Emergency Tyre Repair In Radcliffe
              </h2>
              <p className="text-slate-600 max-w-2xl mx-auto text-base">
                Mobile tyre fitting, emergency tyre replacement and puncture repair across Radcliffe. We come to your home, workplace or roadside location 24/7 with fast response times and professional service.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Emergency%20Tyre%20Fitting%20one%20Stop-airanko-gsjvsGamoet8drKwCMHYr6LH5Ni6ZI.webp', title: 'Mobile Tyre Fitting Radcliffe', desc: 'Mobile tyre fitting at your home, workplace or roadside location anywhere in Radcliffe. Fast response with premium and budget tyre options available.', badge: 'FAST RESPONSE',
                  href: '/mobile-tyre-fitting' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Home%20Tyre%20Fitting%20One%20Stop-airanko-kPAsyn08SjxXwLwCVhxre5zM9jWBTs.webp', title: 'Home Tyre Fitting', desc: 'Same day tyre fitting at your home across Radcliffe, without the hassle of visiting a garage.', badge: 'AT YOUR DOOR',
                  href: '/home-tyre-fitting' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Puncture%20Repair%20One%20Stop-airanko-sfmhLvDbSYmhoMprTVOHCcIWEgJvHf.webp', title: 'Mobile Puncture Repair', desc: 'Professional mobile puncture repair across Radcliffe, carried out on-site where safe and suitable.', badge: 'CERTIFIED REPAIR',
                  href: '/emergency-puncture-repair' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/One%20Stop%20Jumpstart%20image-airanko-cXmOrXcdtaIBMNQOMCIOiPj1C290RG.webp', title: 'Jump Start', desc: 'Flat battery as well as a flat tyre? Our mobile jump start service gets you back on the road in minutes, available 24/7 across Radcliffe.', badge: '24/7 SERVICE',
                  href: '/jump-start' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Tyre%20pressure%20monitor-airanko-sjz7PL2Pv4N9jlPWtz5Wa1q8XO0FgP.webp', title: 'TPMS Reset', desc: 'Tyre pressure monitoring system reset and sensor checks across Radcliffe after every fitting or repair.', badge: 'ALL VEHICLES',
                  href: '/tpms-reset' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Locking%20nut%20removal-airanko%20%281%29-ONBmqaZHMozU0jjrxbPe5J7C4zRQkS.webp', title: 'Locking Nut Removal', desc: 'Specialist, damage-free locking wheel nut removal across Radcliffe using professional tools.', badge: 'DAMAGE FREE',
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <h2 className="text-2xl sm:text-4xl lg:text-5xl text-[#0f172a] mb-5 sm:mb-8 leading-tight font-bold" style={{ fontFamily: 'var(--font-work-sans)' }}>
                Expert Mobile Tyre Fitting Service Across Radcliffe
              </h2>
              <p className="text-slate-600 mb-6 sm:mb-8 leading-relaxed text-base sm:text-lg">
                One Stop Tyres provides 24/7 mobile tyre fitting in Radcliffe, helping drivers get back on the road quickly when they experience a puncture, tyre blowout or damaged tyre.
                Our mobile tyre experts come directly to your home, workplace or roadside location anywhere in Radcliffe and surrounding areas.
                We supply and fit premium and budget tyres, carry out mobile puncture repairs where safe and suitable, and provide emergency tyre replacement services throughout Radcliffe.
                If you&apos;re searching for mobile tyre fitting near me in Radcliffe, our fast response team is available day and night.
              </p>
        ...
        {/* ── 5. WHY CHOOSE US */}
        <WhyChooseUs city="Radcliffe" image="/images/tyre-fitting-in-emergency.webp" />
        ...
        <CityFaq
          ...
          { q: 'How fast can you reach Radcliffe town centre?', a: 'Typically, our nearest technician can be with you in Radcliffe town centre within 20-30 minutes, depending on traffic on Church Street West and Blackburn Street.' },
          { q: 'Do you cover the M66 near Radcliffe?', a: 'Yes. Our vehicles carry high-intensity safety lighting to carry out safe roadside tyre changes near the M66 junctions around Radcliffe and Bury.' },
          { q: 'Do you cover Close, Ainsworth and Outwood as well?', a: 'Yes, we cover the whole of Radcliffe and the surrounding areas including Close, Ainsworth and Outwood, with 24/7 availability.' },
          { q: 'Can you fit tyres near Radcliffe Market or the town centre?', a: 'Absolutely. We regularly attend Radcliffe town centre, including car parks near Radcliffe Market and the Ringley Road shops, fitting tyres wherever it is safe to park.' },
        ]} />

        {/* ── 8. FINAL CTA */}
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="font-h2 text-xl sm:text-2xl lg:text-h2 mb-4 sm:mb-5 leading-tight">Need a Tyre Fitted in Radcliffe Right Now?</h2>
            <p className="font-body-lg text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait by the roadside. Call our dedicated Radcliffe line and get a technician dispatched in minutes.</p>
