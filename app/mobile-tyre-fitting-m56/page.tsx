        ...
        >
          <div className="max-w-2xl py-20">
            ...
            <p className="text-white/80 text-sm sm:text-base leading-relaxed mb-6">
              Emergency Tyre Replacement, Mobile Puncture Repair &amp; Roadside Tyre Assistance On the M56. We Come To Your Location Within 20–30 Minutes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Emergency roadside tyre assistance on the M56. Available 24 hours a day for tyre-related breakdowns and call-outs.',
                  badge: '24/7 SERVICE',
                  href: '/services',
                },
                {
