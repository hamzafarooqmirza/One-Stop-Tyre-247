...
export const metadata = {
  title: 'Mobile Tyre Fitting in Altrincham | 24/7 Tyre Fitting',
  description:
  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/One%20Stop%20Jumpstart%20image-airanko-cXmOrXcdtaIBMNQOMCIOiPj1C290RG.webp', title: 'Roadside Tyre Assistance', desc: 'Emergency roadside tyre assistance throughout Altrincham. Available 24 hours a day for tyre-related breakdowns and call-outs.', badge: '24/7 SERVICE',
                  href: '/services' },
        ...
        {/* ── 5. WHY CHOOSE US */}
        <WhyChooseUs city="Altrincham" image="/images/tyre fitting in emergergency-airanko (1).webp" />
