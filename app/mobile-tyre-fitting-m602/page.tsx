  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      <main>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Emergency tyre replacement service on the M602 for damaged, worn or blown tyres. We get you safely back on the road quickly.',
                  badge: 'AT YOUR DOOR',
                ...
                },
                {
                  ...
                  desc: 'Emergency roadside tyre assistance on the M602. Available 24 hours a day for tyre-related breakdowns and call-outs.',
                  badge: '24/7 SERVICE',
                  href: '/services',
                },
                {
        ...
        {/* ── 5. WHY CHOOSE US ──────────────────────────────── */}
        <WhyChooseUs city="M602" image="/images/tyre fitting in emergergency-airanko (1).webp" />
