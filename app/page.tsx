    ...
    <div className="text-[#1c1b1b]" style={{ fontFamily: 'var(--font-inter)' }}>
      ...
      <div className="fixed bottom-6 right-5 z-[60] flex flex-col gap-3 items-end">
        ...
        <a
          ...
          className="flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1ebe5d] text-white pl-4 pr-5 h-12 rounded-full shadow-lg hover:shadow-xl transition-all"
        >
        ...
        <a
          ...
          className="flex items-center gap-2.5 bg-[#b70011] hover:bg-red-700 text-white pl-4 pr-5 h-12 rounded-full shadow-lg hover:shadow-xl transition-all"
        >
          <span
