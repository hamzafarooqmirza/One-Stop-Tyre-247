...
export const metadata = {
  title: 'Mobile Tyre Fitting M56 | 24/7 Emergency Roadside Assistance | One Stop Tyres 24/7',
}
    ...
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      <main>
        ...
        >
          <div className="max-w-4xl mx-auto py-20">
            <div className="inline-flex items-center gap-2 bg-[#dc2626] text-white px-4 py-2 rounded-full mb-4 animate-pulse">
              ...
              <span className="text-label-bold">24/7 M56 EMERGENCY RESPONSE</span>
            </div>
            <h1
            ...
            >
              ...
              <span className="text-[#b70011]">M56</span>
            </h1>
            <p className="font-body-lg text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed mb-8">Fast and reliable mobile tyre fitting service available 24/7 on the M56 and surrounding junctions. We arrive in 20-30 minutes to get you back on your journey safely — whether you&apos;re heading to Manchester Airport, Chester, or the Wirral.</p>
        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              ...
              >
                Professional Roadside Assistance on the M56
              </h2>
              <p className="text-slate-600 max-w-2xl mx-auto text-sm sm:text-base">
                Comprehensive mobile vehicle support available every day of the year across the M56 corridor and surrounding Cheshire and Greater Manchester routes.
              </p>
            </div>
        ...
        <CityFaq
          ...
          faqs={[
            {
              q: 'Do you cover the entire M56?',
              a: 'Yes, we provide 24/7 coverage from Junction 1 (M60 interchange at Sale) through Manchester Airport (J5/J6), Runcorn, and all the way to Junction 15 at the M53/Chester. We also attend service stations along the route.',
            },
            {
              q: 'Can you reach me near Manchester Airport?',
              a: 'Absolutely. Manchester Airport sits between J5 and J6 of the M56 and is one of our most-served locations. We typically arrive within 20-30 minutes for emergency tyre fitting at the airport approach roads, terminals, and surrounding business parks.',
            },
            {
              q: 'How do I share my location on the M56?',
              a: 'Use the blue driver location signs (markers) every 500m, or send us your What3Words or live GPS location via WhatsApp. We also support service-station meet points if you can safely exit the motorway.',
            },
            {
              q: 'Is it safe to wait for a tyre change on the M56?',
              a: 'Our technicians use specialist high-visibility vans and Chapter 8 safety equipment. We always advise you to exit your vehicle from the left-hand side and wait behind the crash barrier while we work.',
            },
            {
              q: 'What is your average arrival time on the M56?',
              a: 'Our average arrival time across the M56 is 20-30 minutes. Our central Greater Manchester location and Cheshire coverage give us quick access to all junctions from Sale to Chester.',
            },
          ]}
        />
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="font-body-lg text-sm sm:text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait on the hard shoulder. Call our dedicated M56 line and get a technician dispatched in minutes.</p>
