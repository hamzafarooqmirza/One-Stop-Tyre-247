  ...
  return (
    <html lang="en" className={`${workSans.variable} ${inter.variable} bg-[#fcf9f8]`}>
      ...
      <body className="antialiased overflow-x-hidden">
        ...
        <div className="fixed bottom-20 sm:bottom-6 right-4 sm:right-5 z-[60] flex flex-col gap-2 sm:gap-3">
          <a
            href="https://wa.me/447759708646"
            aria-label="Chat on WhatsApp"
            className="w-11 h-11 sm:w-14 sm:h-14 bg-[#25D366] hover:bg-[#1ebe5d] rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all hover:scale-110 active:scale-95"
          >
          ...
          <a
            ...
            className="w-11 h-11 sm:w-14 sm:h-14 bg-[#b70011] hover:bg-red-700 rounded-full shadow-lg hover:shadow-xl flex items-center justify-center transition-all hover:scale-110 active:scale-95"
          >
            <span
              className="material-symbols-outlined text-white text-[22px] sm:text-[26px]"
