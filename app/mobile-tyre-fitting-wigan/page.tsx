        ...
        <section className="py-16 sm:py-24 px-4 sm:px-6 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Mobile%20Tyre%20fitting-airanko-mB2PlClNhJqqD09qARja8bLAbTDtoE.webp', title: 'Mobile Tyre Fitting Wigan', desc: 'Mobile tyre fitting at your home, workplace or roadside location anywhere in Wigan. Fast response with premium and budget tyre options available.', badge: 'FAST RESPONSE' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Home%20Tyre%20Fitting-airanko-NAQrFhRm9UilkOOWhZBEd5lhxc7eEz.webp', title: 'Emergency Tyre Replacement', desc: 'Emergency tyre replacement service across Wigan for damaged, worn or blown tyres. We get you safely back on the road quickly.', badge: 'AT YOUR DOOR' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Emeregency%20Puncture%20Repair-airanko-K3cI9fjWlcirkZkEwDEvdtRtKQg3B7.webp', title: 'Mobile Puncture Repair', desc: 'Professional puncture repair service where safe and suitable. Quick roadside repairs to save you time and money.', badge: 'CERTIFIED REPAIR' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Jumpstart-onestop-airanko-bUQeSwSrfEEeS2vgU2IuyrDFFak87m.webp', title: 'Roadside Tyre Assistance', desc: 'Emergency roadside tyre assistance throughout Wigan. Available 24 hours a day for tyre-related breakdowns and call-outs.', badge: '24/7 SERVICE' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/TPMS%20Reset-airanko-LEqPbQFsdbmM1ZLc5m0aoAUKGG4haJ.webp', title: 'TPMS Reset', desc: 'Tyre pressure monitoring system reset and sensor checks after tyre replacement or puncture repairs.', badge: 'ALL VEHICLES' },
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/Locking%20Nut%20Removal-airanko-MV4iwDQaMKuuoUnbMrRrQW5QIDJQbV.webp', title: 'Locking Nut Removal', desc: 'Specialist locking wheel nut removal service for damaged, seized or missing locking wheel nuts.', badge: 'DAMAGE FREE' },
              ].map((card) => (
