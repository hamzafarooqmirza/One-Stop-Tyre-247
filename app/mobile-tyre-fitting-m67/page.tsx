    ...
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      <main>
        ...
        <section
          ...
          style={{
            backgroundImage: "linear-gradient(to right, rgba(15, 23, 42, 0.92) 0%, rgba(15, 23, 42, 0.45) 100%), url('/images/Mobile%20Tyre%20Fitting%20One%20Stop%20Tyres%2024%207.webp')",
        ...
        >
          <div className="max-w-2xl py-20">
            ...
            <p className="text-white/80 text-sm sm:text-base leading-relaxed mb-6">
              Emergency Tyre Replacement, Mobile Puncture Repair &amp; Roadside Tyre Assistance On the M67. We Come To Your Location Within 20–30 Minutes.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                },
                {
                  ...
                  desc: 'Emergency tyre replacement service on the M67 for damaged, worn or blown tyres. We get you safely back on the road quickly.',
                  badge: 'AT YOUR DOOR',
                ...
                },
                {
                  ...
                  desc: 'Emergency roadside tyre assistance on the M67. Available 24 hours a day for tyre-related breakdowns and call-outs.',
                  badge: '24/7 SERVICE',
                  href: '/services',
                },
                {
        ...
        {/* ── 5. WHY CHOOSE US ──────────────────────────────── */}
        <WhyChooseUs city="M67" image="/images/Tyres fitting anywhere-airanko (1).webp" />
        ...
        <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 bg-[#f0edec] relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="font-body-lg text-sm sm:text-base lg:text-lg text-[#5c403c] leading-relaxed mb-6 sm:mb-8">Don&apos;t wait on the hard shoulder. Call our dedicated M67 line and get a technician dispatched in minutes.</p>
