        ...
        >
          <div className="max-w-4xl mx-auto py-20">
            <div className="inline-flex items-center gap-2 bg-[#dc2626] text-white px-4 py-2 rounded-full mb-4 animate-pulse">
              ...
              <span className="text-label-bold">20-30 MINUTE ARRIVAL IN WIGAN</span>
            </div>
            <h1
            ...
            <p className="font-body-lg text-base sm:text-lg text-white/90 max-w-2xl mx-auto leading-relaxed mb-8">Stranded on the A49 or M6? Our expert mobile technicians provide 24/7 rapid roadside tyre replacement and puncture repair throughout Wigan and the surrounding Greater Manchester area.</p>
