...
export const metadata = {
  ...
  description:
    'Choose trusted mobile tyre fitting in Westhoughton for emergency tyre replacement, same day tyre fitting and professional mobile tyre services delivered to your door.',
