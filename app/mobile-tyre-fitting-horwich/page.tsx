...
export const metadata = {
  title: 'Mobile Tyre Fitting in Horwich | 24/7 Tyre Fitting',
  description:
    'Fast mobile tyre fitting in Horwich. Our technicians come to your home, work or roadside location 24/7, with transparent, upfront pricing and no hidden fees.',
  ...
  return (
    <div className="bg-[#fcf9f8] text-[#1c1b1b] font-body-md">
      ...
      <main>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                { img: 'https://hebbkx1anhila5yf.public.blob.vercel-storage.com/One%20Stop%20Jumpstart%20image-airanko-cXmOrXcdtaIBMNQOMCIOiPj1C290RG.webp', title: 'Roadside Tyre Assistance', desc: 'Emergency roadside tyre assistance throughout Horwich. Available 24 hours a day for tyre-related breakdowns and call-outs.', badge: '24/7 SERVICE',
                  href: '/services' },
        ...
        {/* ── 5. WHY CHOOSE US */}
        <WhyChooseUs city="Horwich" image="/images/tyre fitting in emergergency-airanko (1).webp" />
