...
export default function Home() {
  return (
    <div className="text-[#1c1b1b]" style={{ fontFamily: 'var(--font-inter)' }}>
      ...
      <div className="fixed bottom-6 right-5 z-[60] flex flex-col gap-3 items-end">

        {/* Availability pill — desktop only */}
        <div className="hidden sm:flex items-center gap-2 bg-white/95 backdrop-blur-sm border border-slate-200 shadow-lg rounded-full px-4 py-2">
          <span className="relative flex h-2 w-2">
            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-green-400 opacity-75" />
            <span className="relative inline-flex rounded-full h-2 w-2 bg-green-500" />
          </span>
          <span className="text-[11px] font-bold text-slate-600 uppercase tracking-wider">Techs Available Now</span>
        </div>

        {/* Action card */}
        <div className="bg-white/95 backdrop-blur-sm border border-slate-200 shadow-2xl rounded-2xl overflow-hidden w-[200px]">

          {/* WhatsApp button */}
          <a
            href="https://wa.me/447759708646"
            aria-label="Chat on WhatsApp"
            className="flex items-center gap-3 px-4 py-3.5 bg-[#25D366] hover:bg-[#1ebe5d] transition-colors group"
          >
            ...
            <div className="leading-tight">
              <p className="text-[10px] font-semibold text-white/80 uppercase tracking-widest">WhatsApp</p>
              <p className="text-sm font-black text-white">Chat With Us</p>
            </div>
            <span className="material-symbols-outlined text-white/60 text-base ml-auto group-hover:translate-x-0.5 transition-transform">
              chevron_right
            </span>
          </a>
          ...
          <a
            ...
            className="flex items-center gap-3 px-4 py-3.5 bg-[#b70011] hover:bg-red-700 transition-colors group"
          >
            <div className="w-9 h-9 bg-white/20 rounded-xl flex items-center justify-center flex-shrink-0">
              <span
            ...
            <div className="leading-tight">
              <p className="text-[10px] font-semibold text-white/80 uppercase tracking-widest">Emergency</p>
              <p className="text-sm font-black text-white">Call Now</p>
            </div>
            <span className="material-symbols-outlined text-white/60 text-base ml-auto group-hover:translate-x-0.5 transition-transform">
              chevron_right
            </span>
