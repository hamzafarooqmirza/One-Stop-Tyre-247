...
export const metadata = buildMetadata({
  title: 'Mobile Tyre Fitting in Cardiff | 24/7 Callout | One Stop Tyres',
  description:
    'Same-day mobile tyre fitting in Cardiff — fast tyre replacement & puncture repair at home, work or roadside across CF10 – CF24. Call or WhatsApp.',
      ...
      <main>
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Mobile Tyre Fitting Across Cardiff
            </h2>
            
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              Cardiff's city centre and waterfront Cardiff Bay area see plenty of visitors and commuters, and a punctured tyre is never convenient in either. Our mobile tyre fitting service covers the city centre around St David's Centre, Cardiff Bay and the surrounding suburbs, along with the wider CF postcode area, bringing a fully equipped van directly to your home, workplace or the roadside.
            </p>
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              We're a regular presence around the city centre and Cardiff Bay, and along the M4 and A48 corridors that carry most of the city's commuter and business traffic. Whether you've picked up a puncture heading into the centre or a sidewall cut in a suburban street, our technicians carry the tools and stock to sort it on-site.
            </p>
            <p className="text-slate-600 text-base leading-relaxed">
              Mobile tyre fitting in Cardiff covers everything from a same-day puncture repair to a full emergency tyre replacement after a blowout, with premium, mid-range and budget tyre options fitted to the same standard regardless of price. As a directly employed team, we dispatch to any Cardiff postcode the same day, and every job includes a TPMS check so your dashboard warning light is cleared before we leave.
            </p>
          </div>
        </section>
