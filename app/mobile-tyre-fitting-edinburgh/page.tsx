...
export const metadata = buildMetadata({
  ...
  description:
    'Same-day mobile tyre fitting in Edinburgh — fast, reliable service at your exact location.',
      ...
      <main>
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            ...
            >
              Mobile Tyre Fitting Across Edinburgh
            </h2>
            
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              Edinburgh's Old and New Town cobbles, plus the busy Leith docks area, mean a punctured tyre can happen almost anywhere in the city. Our mobile tyre fitting service covers the city centre around Princes Street, Leith and the surrounding suburbs, along with the wider EH postcode area, bringing a fully equipped van directly to your home, workplace or the roadside.
            </p>
            <p className="text-slate-600 text-base leading-relaxed mb-4">
              We're a regular presence around the city centre and Leith, and along the A1, M8 and the Edinburgh City Bypass (A720) that carry most of the city's commuter traffic. Whether you've picked up a puncture heading into the centre or a sidewall cut in a suburban street, our technicians carry the tools and stock to sort it on-site.
            </p>
            <p className="text-slate-600 text-base leading-relaxed">
              Mobile tyre fitting in Edinburgh covers everything from a same-day puncture repair to a full emergency tyre replacement after a blowout, with premium, mid-range and budget tyre options fitted to the same standard regardless of price. As a directly employed team, we dispatch to any Edinburgh postcode the same day, and every job includes a TPMS check so your dashboard warning light is cleared before we leave.
            </p>
          </div>
        </section>
