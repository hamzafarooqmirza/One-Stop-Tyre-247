      ...
      <section className="relative bg-[#0f172a] overflow-hidden min-h-[80svh] lg:min-h-[600px] flex flex-col lg:flex-row">
        ...
        <div className="relative z-10 w-full lg:w-1/2 flex items-center px-5 sm:px-8 pt-12 pb-10 sm:py-16 lg:py-20">
          <div className="w-full max-w-lg mx-auto lg:ml-auto lg:mr-10">
            ...
            {/* Google Rating Badge */}
            <div className="inline-flex items-center gap-2.5 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-full px-4 py-2 mb-5">
              ...
              <span className="text-white/60 text-xs font-medium">(1,161 Reviews)</span>
            </div>
      ...
      <section className="py-16 sm:py-24 px-4 sm:px-6 bg-[#f8f9fb] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 relative">
            ...
            {[
              { icon: 'tire_repair',    step: 1, title: 'Confirm Your Tyre Size',          desc: 'Tell us your tyre size so we can bring the right fitment.' },
              { icon: 'pin_drop',       step: 2, title: 'Send Us Your Location',            desc: 'Share your live location and our mobile fitter will come to you.' },
              { icon: 'layers',         step: 3, title: 'Choose Branded or Economy Tyres', desc: 'Pick from trusted branded tyres or affordable economy options.' },
